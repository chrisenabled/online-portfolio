define(['createJs'], function(){
    ...
    function checkPaddle() {
        if (puck.velY > 0 && puck.isAlive && puck.nextY > 
            (paddle.y - paddle.height) && puck.nextX >= paddle.x && puck.nextX <=
    ...
    // re-run stage on window resize to fill browser window dynamically
